...
Route::group(['middleware' => ['auth']] , function() {
	...
	Route::get('/edit/book/{id}', 'BooksController@editBook');
	Route::patch('/update/book', 'BooksController@updateBook');

	Route::delete('/delete/book/{id}', 'BooksController@deleteBook');
